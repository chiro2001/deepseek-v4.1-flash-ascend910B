...
export PROFILE=0
export PROFILE_DIR=/opt/dsv41/results/ced_p_1m_20260924/prof
...
echo "[a2] run_id=ced_p_1m_20260924 port=18990 static=0 sptok=7 capture_sizes=1,2,3,4,8,12,16,20,24,32 mseqs=4 prefix=0 moeag=1 local_owner=fast pgo=0 load_format=${LOAD_FORMAT:-real} draft_graph=0 moe_zero=0 moe_nf=0"
