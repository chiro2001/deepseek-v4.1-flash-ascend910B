...
set -uo pipefail
cd /workspace
export MODEL="/home/l00886679/models/out/v41-flat-verify3" TP=8 DP=1 PORT=18993 SERVED_NAME="deepseek-v41-full40-1m"
...
export PROFILE=0
export PROFILE_DIR=/opt/dsv41/results/ced_full40_1m_doublefresh_20260924/prof
...
echo "[a2] run_id=ced_full40_1m_doublefresh_20260924 port=18993 static=0 sptok=7 capture_sizes=1,2,3,4,8,12,16,20,24,32 mseqs=4 prefix=0 moeag=1 local_owner=fast pgo=0 load_format=${LOAD_FORMAT:-real} draft_graph=0 moe_zero=0 moe_nf=0"
