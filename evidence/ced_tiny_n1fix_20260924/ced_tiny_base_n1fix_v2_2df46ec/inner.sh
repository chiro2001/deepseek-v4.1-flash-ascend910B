...
set -uo pipefail
cd /workspace
export MODEL="/home/l00886679/projects/dsv41-ced-singlechip/model-tiny" TP=1 DP=1 PORT=18963 SERVED_NAME="deepseek-v41-ced-tiny"
export MAX_LEN=8192 MAX_SEQS=4 BAT_TOKENS=1024 GPU_UTIL=0.5 BLOCK=128
export QUANTIZATION=none KV_CACHE_MEMORY_BYTES=1073741824 SEED=0
export KV_DTYPE=bfloat16 GRAPH=1 EAGER=0 PREFIX=0 SPEC=0 SP_TOKENS=5
if [ "0" = "1" ]; then export SPEC_EAGER=0; else export SPEC_EAGER=1; fi
export ENGRAM=0 ENGRAM_STORAGE=int8 VISION=0
...
export CAPTURE_SIZES="1,2,3,4,6,8,12,16,20,24,32"
...
export PROFILE=0
export PROFILE_DIR=/opt/dsv41/results/ced_tiny_base_n1fix_v2_2df46ec/prof
...
echo "[a2] run_id=ced_tiny_base_n1fix_v2_2df46ec port=18963 static=0 sptok=5 capture_sizes=1,2,3,4,6,8,12,16,20,24,32 mseqs=4 prefix=0 moeag=1 local_owner=fast pgo=0 load_format=${LOAD_FORMAT:-real} draft_graph=0 moe_zero=0 moe_nf=0"
