A3-21 CED P/D D-eager short needle run
...
P: chips 0-7, TP8, port 18990, KV producer 19090, GRAPH=1 EAGER=0.
D: chips 8-15, TP8, port 18991, KV consumer 19091, GRAPH=0 EAGER=1 (--enforce-eager, no FULL_DECODE_ONLY).
...
Exactly two POST requests. Both HTTP 200 and content ZQ7K-3341, finish_reason=stop, usage prompt/completion/total = 22/8/30, U+FFFD=0.
