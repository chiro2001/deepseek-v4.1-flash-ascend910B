...
set -uo pipefail
cd /workspace
export MODEL="/home/l00886679/models/out/v41-flat-verify3" TP=8 DP=1 PORT=18991 SERVED_NAME="deepseek-v41-ced-pd"
export MAX_LEN=1048576 MAX_SEQS=4 BAT_TOKENS=8192 GPU_UTIL=0.92 BLOCK=128
export QUANTIZATION=ascend KV_CACHE_MEMORY_BYTES= SEED=
...
export MULTISTREAM=0 DSA_OVERLAP=0 FUSED_MC2=0 MC2=0 MC2_HIER=0 REDUCE_SAMPLE=0
...
export PROFILE=0
export PROFILE_DIR=/opt/dsv41/results/ced_prompt_tail_multistream0_graph_20260924_1233/prof
...
echo "[a2] run_id=ced_prompt_tail_multistream0_graph_20260924_1233 port=18991 static=0 sptok=7 capture_sizes=1,2,3,4,8,12,16,20,24,32 mseqs=4 prefix=0 moeag=1 local_owner=fast pgo=0 load_format=${LOAD_FORMAT:-real} draft_graph=0 moe_zero=0 moe_nf=0"
