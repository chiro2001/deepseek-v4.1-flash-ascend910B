...
|---|---:|---:|---:|---|
| **档 B**（当前发布） | ×1.000 + L1 | 22,719 | **197.21 GiB** | ✅ 跨臂非回归 |
| **档 C**（SWA-quant + ring16 + mode3） | **×1.4655** | **33,295** | **≈135 GiB** | ★ **✅ 0/16**（`q-a3`，真命中） |
| **档 D**（+ KV8 双平面 + prefill） | **×1.9133** | **43,469** | **≈103 GiB** | ★ **✅ 0/16**（`q-a4`，真命中） |
