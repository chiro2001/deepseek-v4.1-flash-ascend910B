...
| **档 C**（SWA-quant + ring16 + mode3） | ×1.4655（33,295） | ⚠️ **×1.0000**（427,643）← **draft 顶住** | ≈197 GiB（**无收益**） | ★ ✅ 0/16（`q-a3`，真命中） |
| **档 D**（+ KV8 双平面 + prefill） | ×1.9133（43,469） | ★ **×1.1356**（**485,610**） | **≈174 GiB** | ★ ✅ 0/16（`q-a4`，真命中） |
...
> **在此之前：档 C 在 A2 真权重上【零容量收益】+【图模式捕获期炸】⇒ 不建议上。**
